      ...
      <div className="flex-grow">
        ...
        <div className="mt-2">
          {technologies.map((tech, index) => (
            <span key={index} className="inline-block bg-orange-100 text-orange-800 rounded-full px-3 py-1 text-sm font-semibold mr-2 mb-2">
              {tech}
            </span>
          ))}
        </div>
  ...
  const projects = [
    {
      ...
      technologies: ["Python", "Selenium", "API Integration", "Docker", "Raspberry Pi", "Web Scraping", "Economic Modeling"],
    ...
    },
    {
      ...
      technologies: ["React", "Python", "Flask", "PostgreSQL", "AWS", "Kubernetes", "GitHub Actions", "CI/CD"],
        ...
        <div className="max-w-4xl mx-auto p-8 bg-white shadow-lg rounded-xl text-gray-800">
          <div className="flex flex-col md:flex-row md:items-center mb-6 pb-6 border-b-2 border-blue-200">
            <div className="md:w-1/4 mb-4 md:mb-0">
              <div className={`w-40 h-40 bg-orange-200 rounded-full mx-auto overflow-hidden border-4 border-white shadow-lg ${isAnimating ? 'animate-[dropIn_1s_ease-in-out]' : ''}`}>
                <img 
            ...
            <div className="md:w-3/4 text-center md:text-left">
              <h1 className="text-4xl font-bold text-blue-600 mb-2">Joel van der Boom</h1>
              ...
              <div className="flex flex-col md:flex-row md:items-center text-sm text-gray-600 mt-2">
                <a href="mailto:joelvdb2@gmail.com" className="flex items-center mb-2 md:mb-0 md:mr-4 hover:text-blue-600">
                  <Mail size={16} className="mr-2" />
                  joelvdb2@gmail.com
                </a>
                <a href="tel:+972527214041" className="flex items-center mb-2 md:mb-0 md:mr-4 hover:text-blue-600">
                  <Phone size={16} className="mr-2" />
                  +972-527214041
                </a>
                <a href="https://github.com/joelvdb" target="_blank" rel="noopener noreferrer" className="flex items-center mb-2 md:mb-0 md:mr-4 hover:text-blue-600">
                  <Github size={16} className="mr-2" />
                  GitHub
                </a>
                <a href="https://twitter.com/joelvdb2" target="_blank" rel="noopener noreferrer" className="flex items-center hover:text-blue-600">
              ...
              <a target="_blank" blank href="assests/Joel_van_der_Boom_CV.pdf">
                ...
                <button onClick={handleDownload} className="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded inline-flex items-center transition-all duration-300 transform hover:scale-105">
          ...
          <section className="mb-6 bg-gray-50 rounded-lg shadow-md p-4">
            <h2 className="text-2xl font-semibold text-blue-600 mb-3 pb-1 border-b border-blue-200">Summary</h2>
            <p className="text-gray-600 leading-relaxed">
              Currently a computer science and economics B.Sc student at the Hebrew University of Jerusalem (HUJI) and working as a skilled full stack web developer at the IDF. Passionate about using technology to solve real-world problems and exploring the world of finance through data analysis. In addition I like to read about blockchain technology and its potential to revolutionize the financial industry. I am seeking opportunities to further develop my skills.
            </p>
          </section>

          <section className="mb-6 bg-gray-50 rounded-lg shadow-md p-4">
            <h2 className="text-2xl font-semibold text-blue-600 mb-3 pb-1 border-b border-blue-200">Experience</h2>
          ...
          <section className="mb-6 bg-gray-50 rounded-lg shadow-md p-4">
            <h2 className="text-2xl font-semibold text-blue-600 mb-3 pb-1 border-b border-blue-200">Projects</h2>
            {projects.length > 0 ? (
          ...
          <section className="mb-6 bg-gray-50 rounded-lg shadow-md p-4">
            <h2 className="text-2xl font-semibold text-blue-600 mb-3 pb-1 border-b border-blue-200">Education</h2>
            <div>
              <h3 className="text-xl font-medium text-orange-500">B.Cs. in Computer Science and Economics</h3>
              <p className="text-sm text-gray-500 italic">Hebrew University of Jerusalem, 2021 - Present (Anticipated graduation: Summer 2024)</p>
            </div>
          </section>

          <section className="bg-gray-50 rounded-lg shadow-md p-4">
            <h2 className="text-2xl font-semibold text-blue-600 mb-3 pb-1 border-b border-blue-200">Skills</h2>
            <div className="flex flex-wrap gap-2">
              {['React Native', 'React', 'MUI', 'CSS', 'JavaScript', 'Node.js', 'Express.js', 'SQL', 'Python', 'pandas', 'numpy', 'selenium', 'Photoshop'].map((skill) => (
                <span key={skill} className="bg-gradient-to-r from-blue-100 to-orange-100 text-gray-800 text-sm font-medium px-4 py-1 rounded-full shadow-sm">
                  {skill}
                </span>
              ))}
            </div>
